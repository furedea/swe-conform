...
CLASSIFICATION_PROMPT_VERSION = "code-test-rule-v11"
...
_CLASSIFICATION_PROMPT_PATH = Path(__file__).resolve().parents[1] / "prompts" / "markdown_file_classification_v11.md"
